    ...
    return ( <>
        ...
        <section>
            <div className="container-fluid">
                <div className="row">
                    <div className="col-lg-6 col-xs-6 contact-bg d-flex align-items-end pb-5">
                        <div className="">
                            <Image src={ContactBgImage} alt="Contact Us background image" width={491} height={491} />
                        </div>
                    </div>
                    <div className="col-lg-6 col-xs-6 d-flex">
                        <div className='row'>
                            <div className='col-lg-12 col-xs-12'>
                                <div className='px-5 pt-5'>
                                    <div className='pb-3'>
                                        <h6 className='pb-3'>Talk to us</h6>
                                    ...
                                    <div className='pt-4'>
                                        ...
                                        <a href="#"><button className="btn btn-primary text-white">BOOK DEMO</button></a>
                                    </div>
                                </div>
                            </div>
                            <div className='col-lg-12 col-xs-12 contact-form-div px-5 pt-5 pb-3 mt-5'>
                                    <form className='px-0'>
                                        <div className='row'>
                                            <div className="col-lg-6 col-xs-12 mb-4">
                                                <input type="text" className="form-control rounded-0" id="Name" placeholder='Name *'/>
                                            </div>
                                            <div className="col-lg-6 col-xs-12 mb-4">
