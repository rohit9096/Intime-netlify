        ...
        <div className="pt-4 main-footer">
            ...
            <div className="row pt-4 border-bottom border-opacity-50 border-dark border-1 pb-4 page-footer d-lg-flex flex-lg-nowrap">
                <div className="col-lg-2 col-xs-12 about-company">
                    ...
                    <li className='mb-3'><Link href='/#features' scroll={false}><a className='fw-light text-decoration-none' >View All Features</a></Link></li>
                ...
                <div className="col-lg-2 col-xs-12 links ps-5 ps-md-2 ms-md-1 ms-sm-1" id='ps-sm-2'>
                    <p className=' text-dark fw-bold mb-3'>Company</p>
                        <ul className="m-0 p-0 list-unstyled">
                            ...
                            <li className='mb-3'><Link href='#' scroll={false}><span className=' fw-light text-decoration-none text-muted'>Terms & Conditions</span></Link></li>
                            <li className='mb-3'><Link href='#' scroll={false}><span className=' fw-light text-decoration-none text-muted'>Privacy Policy</span></Link></li>
                ...
                <div className="col-lg-2 col-xs-12 links">
                    <p className='text-dark fw-bold mb-3'>Support</p>
                        <ul className="m-0 p-0 list-unstyled">
                            ...
                            <li className='mb-3'><Link href="#"><span className=' fw-light text-decoration-none text-muted'> Raise Ticket</span></Link></li>
                        ...
                        <div className=''>
                                ...
                                <p className='text-dark fw-bold mb-3'>Downloads</p>
                                        ...
                                        <div className='col-lg-4 download-card mb-3'>
                                            <div className='bg-white shadow-sm rounded px-3 d-flex align-items-end justify-content-center'>
                                                {/* <Link href='/download-windows'> */}
                                                    <span className='d-flex align-items-center gap-2 text-decoration-none py-2'>
                                                        <div className='mt-1'>
                                        ...
                                        <div className='col-lg-4 download-card mb-3'>
                                            <div className='bg-white shadow-sm rounded d-flex align-items-end justify-content-center'>
                                        ...
                                        <div className='col-lg-4 download-card mb-3'>
                                            <div className='bg-white shadow-sm rounded px-3 d-flex align-items-end justify-content-center'>
                                                {/* <Link href='/download-iOS'> */}
                                                    <span className='d-flex align-items-center gap-2 text-decoration-none py-2'>
                                                        <div className='mt-1'>
                                                            <Image src={LinuxLogo} alt="Microsoft logo" width={32} height={28} />
                                                        </div>
                                                        <div className='pe-1'>
                                                            {/* <small className='text-muted download-text'>Download on the</small> */}
                                ...
                                <div className='row pt-4'>
                                        ...
                                        <div className='col-lg-4 download-card'>
                                            <div className='bg-white shadow-sm rounded px-4 d-flex align-items-end justify-content-center'>
                                        ...
                                        <div className='visibility-hidden col-lg-4 download-card'>
                                            <div className='bg-white shadow-sm download-card rounded d-flex align-items-end justify-content-center'>
                                                <Link href='#'>
