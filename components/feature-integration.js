                    ...
                    <div className="tab-pane fade show active" id="home-tab-pane" role="tabpanel" aria-labelledby="home-tab" tabIndex="0">
                        <div className='row text-lg-center text-xxl-start text-xl-start text-sm-center'>
                            ...
                            <div className='col-xxl-6 col-xl-6 col-lg-12 col-md-12 col-sm-12 mb-4'>
                                ...
                                <p className='text-muted fs-5 pt-4 me-lg-0 pe-lg-0 sm-me-0 sm-px-0 here-out'>With intime pro, managing teams, projects and clients has become way easier, assigning new tasks to team members and allocate required resources to projects in few simple clicks.</p>
                            </div>
                        </div>
                    </div>
                    <div className="tab-pane fade" id="profile-tab-pane" role="tabpanel" aria-labelledby="profile-tab" tabIndex="0">
                        <div className='row text-lg-center text-xxl-start text-xl-start text-sm-center'>
                            ...
                            <div className='col-xxl-6 col-xl-6 col-lg-12 col-md-12 col-sm-12 mb-4'>
                                ...
                                <p className='text-muted fs-5 pt-4 me-lg-0 pe-lg-0 sm-me-0 sm-px-0 here-out'>I work with various teams and intime pro has helped me share information with my team mates even when I work remotely.</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="tab-pane fade" id="disabled-tab-pane" role="tabpanel" aria-labelledby="disabled-tab" tabIndex="0">
                        <div className='row text-lg-center text-xxl-start text-xl-start text-sm-center'>
                            ...
                            <div className='col-xxl-6 col-xl-6 col-lg-12 col-md-12 col-sm-12 mb-4'>
                                ...
                                <p className='text-muted fs-5 pt-4 me-lg-0 pe-lg-0 sm-me-0 sm-px-0 here-out'>using intime pro, I am able to evaluate and improve my personal productivity by prioritizing tasks and complete them in a timely manner thus contributing to the success of the project.</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="tab-pane fade" id="HExecutive-tab-pane" role="tabpanel" aria-labelledby="HExecutive-tab" tabIndex="0">
                        <div className='row text-lg-center text-xxl-start text-xl-start text-sm-center'>
                            ...
                            <div className='col-xxl-6 col-xl-6 col-lg-12 col-md-12 col-sm-12 mb-4'>
                                ...
                                <p className='text-muted fs-5 pt-4 me-lg-0 pe-lg-0 sm-me-0 sm-px-0 here-out'>intime pro allows me to gauge an employee's performance based on his ability to complete tasks in timely fashion, which helps in planning areas of improvement and to strengthen his career path.</p>
                            </div>
                        </div>
                    </div>
